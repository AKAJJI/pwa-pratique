...
function loadTechnologies(technos) {
    ...
    fetch('https://us-central1-pwa-technos-lkj.cloudfunctions.net/getTechnos')
        .then(response => {
            response.json()
                .then(technos => {
...
if(navigator.serviceWorker) {
    ...
    navigator.serviceWorker
        ...
        .then(registration =>{
            ...
            const publicKey = "BB5XJpUy1u8Gtw-gxhOmGUVXUwoZdDhwyKbhm80X-IEVD7SCiy4Zugi2QiXi7ithE_dWSjWgza4f8WqjnEaJuVg";
